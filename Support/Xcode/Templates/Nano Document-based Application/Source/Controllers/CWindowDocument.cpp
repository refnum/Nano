...
{	OSStatus	theErr;
	...
	// Encode our state
	theState.SetValueString(kDocAuthor,      mInfo.theAuthor);
	theState.SetValueString(kDocDescription, mInfo.theDescription);
	
	theErr = mExampleView->EncodeState(theState);
...
{	OSStatus	theErr;
	...
	// Decode our state
	mInfo.theAuthor      = theState.GetValueString(kDocAuthor);
	mInfo.theDescription = theState.GetValueString(kDocDescription);

	theErr = mExampleView->DecodeState(theState);
