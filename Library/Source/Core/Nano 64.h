...
//		Compatibility
//----------------------------------------------------------------------------
// Although Xcode 2.4 supports 64-bit builds, these can not be deployed prior
// to the official 10.5/Xcode 3.0 release.
//
...
// allow 64-bit builds to be performed with Xcode 2.4.
//
