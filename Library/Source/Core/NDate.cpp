...
//============================================================================
//		NDate::== : Are two dates equal?
//----------------------------------------------------------------------------
bool NDate::operator == (const NDate &theDate) const
{
...
{	CFComparisonResult	theResult;
	...
	// Compare the dates
	theResult = Compare(theDate);
	return(theResult == kCFCompareLessThan || theResult == kCFCompareEqualTo);
}
...
bool NDate::operator > (const NDate &theDate) const
{
	...
	// Compare the dates
	return(Compare(theDate) == kCFCompareGreaterThan);
}
...
{	CFComparisonResult	theResult;
	...
	// Compare the dates
	theResult = Compare(theDate);
	return(theResult == kCFCompareGreaterThan || theResult == kCFCompareEqualTo);
}
...
//============================================================================
//		NDate::Compare : Compare a date.
//----------------------------------------------------------------------------
#pragma mark -
CFComparisonResult NDate::Compare(const NDate &theDate) const
{
