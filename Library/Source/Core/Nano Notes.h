/*	NAME:
	...
	DESCRIPTION:
		...
		For example:
		    ...
		    #define NN_SEEN_RELEASE_NOTES_FOR			0x00100500
...
//----------------------------------------------------------------------------
	...
	//
	// See NIcon.h
	#warning "1.5: NIcon(OSType, OSType) has swapped type/creator order"


	// NXMLTree
	//
	// See NXMLTree.h
	#warning "1.5: NXMLTree::GetElementContents renamed to NXMLTree::GetElementValue"
