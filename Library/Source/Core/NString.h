...
public:
	...
	// Find a substring
	//
	// If the length of theRange is 0, the search is to the end of the string.
	CFRange								Find(   const NString &theString, CFOptionFlags theFlags=0, const CFRange &theRange=CFRangeMake(0,0)) const;
	CFRangeList							FindAll(const NString &theString, CFOptionFlags	theFlags=0, const CFRange &theRange=CFRangeMake(0,0)) const;
	...
	// Trim the string
	void								TrimString(const NString &theString);
