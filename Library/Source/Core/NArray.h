...
class NArray :	public NCFObject,
				public NContainer {
public:
										NArray(const UInt32List  &theValues);
										NArray(const UInt64List  &theValues);
	...
	// Get/set a value
	NCFObject							GetValue(          UInt32 theIndex) const;
	...
	UInt64								GetValueUInt64(    UInt32 theIndex) const;
	...
	void								SetValue(          UInt32 theIndex, const NCFObject   &theValue);
	...
	void								SetValueUInt64(    UInt32 theIndex, UInt64             theValue);
	void								SetValueFloat32(   UInt32 theIndex, Float32            theValue);
	...
	// Get/set the array values
	UInt32List							GetValuesUInt32( void) const;
	UInt64List							GetValuesUInt64( void) const;
	Float32List							GetValuesFloat32(void) const;
	Float64List							GetValuesFloat64(void) const;
	NStringList							GetValuesString( void) const;

	void								SetValuesUInt32( const UInt32List  &theValues);
	void								SetValuesUInt64( const UInt64List  &theValues);
	...
	// Append a value
	void								AppendValue(          const NCFObject   &theValue);
	void								AppendValueBoolean(   bool               theValue);
	void								AppendValueOSType(    OSType             theValue);
	void								AppendValueUInt32(    UInt32             theValue);
	void								AppendValueUInt64(    UInt64             theValue);
	void								AppendValueFloat32(   Float32            theValue);
