...
public:
	...
	NCFDate								GetValueDate(      UInt32 theIndex) const;
	...
	void								SetValueDate(      UInt32 theIndex, const NCFDate     &theValue);
	...
	void								AppendValueDate(      const NCFDate     &theValue);
...
private:
	void								InitializeSelf(CFArrayRef cfArray);
