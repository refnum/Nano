...
{	EventRef	theEvent;
	...
	// Create the event
	theErr = CreateEvent(NULL, theClass, theKind, GetCurrentEventTime(), kEventAttributeNone, &theEvent);
	if (theErr != noErr)
		theEvent = NULL;
...
//============================================================================
//		NCarbonEvent::SetParameterDrag : Set an DragRef parameter.
//----------------------------------------------------------------------------
...
{	CGContextRef	theValue;
	...
	// Get the parameter
	GetParameter(kEventParamCGContextRef, typeCGContextRef, sizeof(CGContextRef), &theValue);
...
{	EventMouseButton	theValue;
	...
	// Get the parameter
	theValue = GetParameter(kEventParamMouseButton, typeMouseButton, sizeof(theValue), &theValue);
...
{	EventMouseWheelAxis	theValue;
	...
	// Get the parameter
	theValue = GetParameter(kEventParamMouseWheelAxis, typeMouseWheelAxis, sizeof(theValue), &theValue);
