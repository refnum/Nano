...
enum {
	...
	// Application events
	kEventClassNApplication											= 'Napp',
	kEventNAppGetUndoManager,


	// Control events
	kEventClassNControl												= 'Nctl',
	kEventNControlInitialized,
    kEventNControlTrackingAreaWithin,


	// Mouse events
	//
    // CarbonEvents.h does not define kEventMouseScroll util 10.5, however it is
	// also available on 10.4.
	//
	// See http://developer.apple.com/qa/qa2005/qa1453.html for more information.
	...
	// Window events
	//
	// This event is sent when a window is restored from the dock. It has been supported
	// since 10.0, but not officially documented.
	//
	// See http://lists.apple.com/archives/carbon-dev/2007/Jul/msg00328.html for more information.
	...
	kEventNWebInterfaceContextualMenu,
	...
	kEventNWebPolicyNewWindow,
	kEventNWebPolicyNavigationAction
};
...
enum {
	...
	// kEventCommand / kEventCommandProcess
	kEventNParamSpellReplacement									= 'Nsrp',	// typeCFTypeRef		(typeCFStringRef)
	kEventNParamSpellSessionID										= 'Nses',	// typeSInt32


	// kEventClassMouse / kEventMouseScroll
	//
	// See above for kEventMouseScroll definition.
	#if NN_SDK_VERSION < NN_SDK_VERSION_10_5
	...
	kEventNParamActionInfo											= 'Nain',	// typeCFTypeRef		(typeCFDictionaryRef)
	...
	kEventNParamMenuItems											= 'Nmen',	// typeCFTypeRef		(typeCFMutableArrayRef)
	kEventNParamName												= 'Nnam',	// typeUnicodeText
	...
	kEventNParamPolicy												= 'Npol',	// typeUnicodeText
...
enum {
	...
	//
	// This command is typically processed by NApplication.
	kHICommandNToggleColorPanel										= 'cptg',
	...
	// Edit session
	//
	// These commands are typically generated by NEditText.
	kHICommandNEditAccept											= 'Neok',
	kHICommandNEditCancel											= 'Nent',
...
protected:
	...
	virtual OSStatus					DoEventFontPanelClosed(NCarbonEvent &theEvent);
	virtual OSStatus					DoEventFontSelection(  NCarbonEvent &theEvent);
	...
	virtual OSStatus					DoEventMouseScroll(		NCarbonEvent &theEvent);
    ...
    virtual OSStatus                    DoEventNControlTrackingAreaWithin(NCarbonEvent &theEvent);
	...
	virtual OSStatus					DoEventNWebPolicyNewWindow(					NCarbonEvent &theEvent);
	virtual OSStatus					DoEventNWebPolicyNavigationAction(			NCarbonEvent &theEvent);

	virtual OSStatus					DoEventSearchFieldCancelClicked(NCarbonEvent &theEvent);
	virtual OSStatus					DoEventSearchFieldSearchClicked(NCarbonEvent &theEvent);
	...
	virtual OSStatus					DoEventWindowRestoreFromDock(		NCarbonEvent &theEvent);
