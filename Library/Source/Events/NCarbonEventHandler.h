...
enum {
	// Toggle toolbar
	//
	// Although HIToolbar.h provides commands to show and hide a toolbar,
	// typically a single menu command would be used to adjust a toolbar's
	// visibility.
	//
	// This command (requested as rdar://4409814) can be used to produce a
	// menu item that will toggle the visibility of the window's toolbar,
	// and whose text switches between "Show Toolbar" and "Hide Toolbar".
	//
	// This command is typically processed by NWindowController.
	kHICommandNToggleToolbar										= 'Ntog',
...
private:
	...
	OSStatus							UpdateCommandStatus(NCarbonEvent &theEvent);
