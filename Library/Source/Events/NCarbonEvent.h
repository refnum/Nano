...
public:
	...
	CFIndex								GetParameterCFIndex(      EventParamName theParam) const;
	CFRange								GetParameterCFRange(      EventParamName theParam) const;
	CFTypeRef							GetParameterCFType(       EventParamName theParam) const;
	DragRef								GetParameterDrag(         EventParamName theParam) const;
	EventRef							GetParameterEvent(        EventParamName theParam) const;
	...
	OSStatus							SetParameterCFIndex(      EventParamName theParam, CFIndex                  theValue);
	OSStatus							SetParameterCFRange(      EventParamName theParam, const CFRange           &theValue);
	...
	OSStatus							SetParameterEvent(        EventParamName theParam, EventRef                 theValue);
	...
	HIPoint								GetMouseScrollDelta(void) const;
	...
	void								SetMouseScrollDelta(const HIPoint     &theValue);


	// Get/set view parameters
	HIViewPartCode						GetViewPartCode(      void) const;
	HIViewTrackingAreaID				GetViewTrackingAreaID(void) const;
