...
void NByteSwap::SwapInt32(UInt32 *theValue)
{
	...
	*theValue =	(((UInt32) ((*theValue) & 0xFF000000)) >> 24) |
				(((UInt32) ((*theValue) & 0x00FF0000)) >> 16) |
				(((UInt32) ((*theValue) & 0x0000FF00)) >>  8) |
				(((UInt32) ((*theValue) & 0x000000FF)) >>  0);
}
...
void NByteSwap::SwapInt64(UInt64 *theValue)
{
	...
	*theValue =	(((UInt64) ((*theValue) & 0xFF00000000000000ULL)) >> 56) |
				(((UInt64) ((*theValue) & 0x00FF000000000000ULL)) >> 48) |
				(((UInt64) ((*theValue) & 0x0000FF0000000000ULL)) >> 40) |
				(((UInt64) ((*theValue) & 0x000000FF00000000ULL)) >> 32) |
				(((UInt64) ((*theValue) & 0x00000000FF000000ULL)) >> 24) |
				(((UInt64) ((*theValue) & 0x0000000000FF0000ULL)) >> 16) |
				(((UInt64) ((*theValue) & 0x000000000000FF00ULL)) >>  8) |
				(((UInt64) ((*theValue) & 0x00000000000000FFULL)) >>  0);
}
