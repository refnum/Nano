...
//		Internal constants
//----------------------------------------------------------------------------
static const CFStringRef kUTIColorType						= UTTypeCreatePreferredIdentifierForTag(kUTTagClassNSPboardType, (CFStringRef) NSColorPboardType, NULL);
...
extern const NUTI kUTNTypeColor								= kUTIColorType;
extern const NUTI kUTNTypeFileURL							= CFSTR("public.file-url");
extern const NUTI kUTNTypeImage								= CFSTR("public.image");
extern const NUTI kUTNTypeItem								= CFSTR("public.item");
extern const NUTI kUTNTypeJPEG								= CFSTR("public.jpeg");
extern const NUTI kUTNTypePICT								= CFSTR("com.apple.pict");
extern const NUTI kUTNTypePNG								= CFSTR("public.png");
extern const NUTI kUTNTypeRTF								= CFSTR("public.rtf");
extern const NUTI kUTNTypeUTF8PlainText						= CFSTR("public.utf8-plain-text");
extern const NUTI kUTNTypeUTF16PlainText					= CFSTR("public.utf16-plain-text");
