...
public:
	...
	// Get values from the pasteboard
	NStringList							GetValuesText(void) const;
	NFileList							GetValuesFile(void) const;


private:
	void								InitializeSelf(PasteboardRef thePasteboard, bool takeOwnership);
