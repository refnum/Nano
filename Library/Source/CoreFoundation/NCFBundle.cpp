...
{	NCFURL		baseURL, resURL, theURL;
	...
	theURL.Set(CFURLCreateAbsoluteURLWithBytes(kCFAllocatorNano, (const UInt8 *) thePath.GetUTF8(), thePath.GetSizeBytes(), kCFStringEncodingUTF8, baseURL, false));
...
//============================================================================
//		NCFBundle::GetFunction : Get a function pointer from the bundle.
//----------------------------------------------------------------------------
void *NCFBundle::GetFunction(const NString &theName)
{
	...
	// Get the pointer
	return(CFBundleGetFunctionPointerForName(*this, theName));
}
...
//============================================================================
//		NCFBundle::GetSymbol : Get a symbol pointer from the bundle.
//----------------------------------------------------------------------------
void *NCFBundle::GetSymbol(const NString &theName)
{
	...
	// Get the pointer
	return(CFBundleGetDataPointerForName(*this, theName));
}
