...
NCFPreferences::NCFPreferences(const NString &appID)
{
	...
	//
	// Note that CFPreferences looks for the kCFPreferencesCurrentApplication
	// pointer, rather than comparing its value, and so we need to work with
	// a raw CFStringRef rather than using an NString.
	mAppID = appID;
	CFSafeRetain(mAppID);
...
//============================================================================
//		NCFPreferences::HasKey : Does a preference key exist?
//----------------------------------------------------------------------------
bool NCFPreferences::HasKey(const NString &theKey, bool checkDefaults)
{	bool		hasValue;
	NCFObject	cfValue;
...
//============================================================================
//		NCFPreferences::RemoveKey : Remove a preference key.
//----------------------------------------------------------------------------
void NCFPreferences::RemoveKey(const NString &theKey)
{
...
//============================================================================
//		NCFPreferences::GetValueAlias : Get an alias value.
//----------------------------------------------------------------------------
NAlias NCFPreferences::GetValueAlias(const NString &theKey) const
{	NAlias		theResult;
	NData		theData;
	...
	// Get the value
	if (theData.Set(CFPreferencesCopyAppValue(theKey, mAppID)))
...
//----------------------------------------------------------------------------
NDate NCFPreferences::GetValueDate(const NString &theKey) const
{
...
//============================================================================
//		NCFPreferences::SetValueAlias : Set an alias value.
//----------------------------------------------------------------------------
void NCFPreferences::SetValueAlias(const NString &theKey, const NAlias &theValue)
{	NData	theData;
	...
	if (theValue.IsValid())
		{
		theData = theValue.GetData();
		if (theData.IsValid())
			CFPreferencesSetAppValue(theKey, theData, mAppID);
		}
}
...
//----------------------------------------------------------------------------
void NCFPreferences::SetValueDate(const NString &theKey, const NDate &theValue)
{
