...
static const NString kBundleIDiTunes							= "com.apple.iTunes";
static const NString kBundleIDiPhoto							= "com.apple.iPhoto";
static const NString kBundleIDSafari							= "com.apple.mail";
static const NString kBundleIDMail								= "com.apple.Safari";
...
public:
	...
	// Get a function/symbol pointer from the bundle
	void								*GetFunction(const NString &theName);
	void								*GetSymbol(  const NString &theName);
};
