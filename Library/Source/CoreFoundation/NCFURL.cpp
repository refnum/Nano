...
NCFURL::NCFURL(const NString &theString)
{
	...
	// Initialize ourselves
	InitializeSelf(CFURLCreateWithString(NULL, theString, NULL));
}
...
NCFURL::NCFURL(const NData &theData, CFStringEncoding theEncoding)
{
	...
	// Initialize ourselves
	InitializeSelf(CFURLCreateWithBytes(NULL, theData.GetData(), theData.GetSize(), theEncoding, NULL));
}
...
NCFURL::NCFURL(const NFile &theFile)
{
	...
	// Initialize ourselves
	InitializeSelf(CFURLCreateWithFileSystemPath(NULL, theFile.GetPath(), kCFURLPOSIXPathStyle, false));
}
...
{	static CFURLRef		sDefaultURL = CFURLCreateWithString(NULL, CFSTR("file://localhost/"), NULL);
