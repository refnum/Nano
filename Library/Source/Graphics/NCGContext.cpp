...
NCGContext::NCGContext(const NCarbonEvent &theEvent, bool saveState, HIThemeOrientation	theOrientation)
{
	...
	InitializeSelf(theEvent.GetCGContext(), false, saveState, theOrientation);
}
...
NCGContext::NCGContext(CGContextRef cgContext, bool saveState, HIThemeOrientation theOrientation)
{
	...
	// Initialize ourselves
	InitializeSelf(cgContext, false, saveState, theOrientation);
}
...
{	CGContextRef	cgContext;
	...
	// Initialize ourselves
	InitializeSelf(cgContext, true, false, kHIThemeOrientationInverted);
}
...
//----------------------------------------------------------------------------
#pragma mark -
void NCGContext::InitializeSelf(CGContextRef cgContext, bool takeOwnership, bool saveState, HIThemeOrientation theOrientation)
{
