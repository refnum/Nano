...
//----------------------------------------------------------------------------
CGFunctionRef NCGShading::CreateEvaluateCallback(void)
{	static const float					kCallbackDomain[] = { 0.0f, 1.0f, 0.0f, 1.0f, 0.0f, 1.0f, 0.0f, 1.0f };
	static const CGFunctionCallbacks	kCallbackInfo     = { 0, NCGShading::EvaluateCallback, NULL          };



	// Create the callback
	return(CGFunctionCreate((void *) this, 1, NULL, 4, kCallbackDomain, &kCallbackInfo));
}
