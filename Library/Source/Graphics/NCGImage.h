...
typedef std::vector<NCGImage>									NCGImageList;
typedef NCGImageList::iterator									NCGImageListIterator;
typedef NCGImageList::const_iterator							NCGImageListConstIterator;
...
public:
										...
										NCGImage(CGImageRef cgImage = NULL);
