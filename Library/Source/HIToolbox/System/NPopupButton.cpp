...
//============================================================================
//      NPopupButton::UpdateMenuSize : Update the menu size.
//----------------------------------------------------------------------------
void NPopupButton::UpdateMenuSize(void)
{


	// Update the menu size
	//
	// The pop-up button can only select menu items that fall within its min/max
	// range, and so we adjust this range to keep it in sync with the menu size.
	SetMaximumValue(GetMenu().GetSize());
	SetMinimumValue(1);
}
...
//============================================================================
//		NPopupButton::GetCurrentCommand : Get the current command.
//----------------------------------------------------------------------------
UInt32 NPopupButton::GetCurrentCommand(void) const
{	NMenuItem		menuItem(GetMenu(), GetCurrentValue(), false);
...
//============================================================================
//		NPopupButton::SetCurrentCommand : Set the current command.
//----------------------------------------------------------------------------
void NPopupButton::SetCurrentCommand(UInt32 theCmd)
