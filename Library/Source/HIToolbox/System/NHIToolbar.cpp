...
OSStatus NHIToolbar::DoEventToolbarGetAllowedIdentifiers(NCarbonEvent &theEvent)
{
	...
	// Add the items
    return(AddItems(theEvent, kHIToolbarItemBehaviourInConfig));
}
...
OSStatus NHIToolbar::DoEventToolbarGetDefaultIdentifiers(NCarbonEvent &theEvent)
{
	...
	// Add the items
    return(AddItems(theEvent, kHIToolbarItemBehaviourIsDefault));
}
...
OSStatus NHIToolbar::DoEventToolbarGetSelectableIdentifiers(NCarbonEvent &theEvent)
{
	...
	// Add the items
	return(AddItems(theEvent, kHIToolbarItemBehaviourIsSelectable));
}
...
//----------------------------------------------------------------------------
#pragma mark -
OSStatus NHIToolbar::AddItems(NCarbonEvent &theEvent, OptionBits theMask)
{	OptionBits								theFlags;
