...
public:
	...
	// Handle drags
	virtual bool						CanDrag(    DataBrowserItemID itemID, DragReference theDrag);
	virtual bool						AcceptDrag( DataBrowserItemID itemID, DragReference theDrag);
	virtual bool						ReceiveDrag(DataBrowserItemID itemID, DragReference theDrag);
	virtual void						FinishDrag(OSStatus      trackResult, DragReference theDrag);
...
protected:
	...
	NCFDate								GetItemDate(      DataBrowserItemDataRef itemData) const;
	...
	void								SetItemDate(     DataBrowserItemDataRef itemData, const NCFDate    &theValue);
