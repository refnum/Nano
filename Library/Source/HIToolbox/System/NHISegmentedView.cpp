...
{	NCFBundle	appBundle;
	...
	if (HasProperty(                                               kPropertyNano, kTagSegment0Image))
		SetSegmentImage(0, appBundle.GetResource(GetPropertyString(kPropertyNano, kTagSegment0Image)));

	if (HasProperty(                                               kPropertyNano, kTagSegment1Image))
		SetSegmentImage(1, appBundle.GetResource(GetPropertyString(kPropertyNano, kTagSegment1Image)));

	if (HasProperty(                                               kPropertyNano, kTagSegment2Image))
		SetSegmentImage(2, appBundle.GetResource(GetPropertyString(kPropertyNano, kTagSegment2Image)));

	if (HasProperty(                                               kPropertyNano, kTagSegment3Image))
		SetSegmentImage(3, appBundle.GetResource(GetPropertyString(kPropertyNano, kTagSegment3Image)));

	if (HasProperty(                                               kPropertyNano, kTagSegment4Image))
		SetSegmentImage(4, appBundle.GetResource(GetPropertyString(kPropertyNano, kTagSegment4Image)));

	if (HasProperty(                                               kPropertyNano, kTagSegment5Image))
		SetSegmentImage(5, appBundle.GetResource(GetPropertyString(kPropertyNano, kTagSegment5Image)));

	if (HasProperty(                                               kPropertyNano, kTagSegment6Image))
		SetSegmentImage(6, appBundle.GetResource(GetPropertyString(kPropertyNano, kTagSegment6Image)));

	if (HasProperty(                                               kPropertyNano, kTagSegment7Image))
		SetSegmentImage(7, appBundle.GetResource(GetPropertyString(kPropertyNano, kTagSegment7Image)));

	if (HasProperty(                                               kPropertyNano, kTagSegment8Image))
		SetSegmentImage(8, appBundle.GetResource(GetPropertyString(kPropertyNano, kTagSegment8Image)));

	if (HasProperty(                                               kPropertyNano, kTagSegment9Image))
		SetSegmentImage(9, appBundle.GetResource(GetPropertyString(kPropertyNano, kTagSegment9Image)));
