...
{	OptionBits		theAttributes;
	...
	// Get the attributes
	//
	// DataBrowserGetAttributes is only available on 10.4.
...
{	OSStatus	theErr;
	...
	// Set the attributes
	//
	// DataBrowserChangeAttributes is only available on 10.4.
...
{	float		theValue;
	...
	// Get the metric
	//
	// DataBrowserGetMetric is only available on 10.4.
...
{	bool		isDefault;
	...
	// Set the metric
	//
	// DataBrowserSetMetric is only available on 10.4.
...
{	OSStatus	theErr;
	...
	// Set the origin
	theErr = SetDataBrowserScrollPosition(*this, (UInt32) theOrigin.x, (UInt32) theOrigin.y);
	NN_ASSERT_NOERR(theErr);
}
