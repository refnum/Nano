...
{	const EventTypeSpec	theEvents[] = { { kEventClassToolbarItem, kEventToolbarItemCreateCustomView },
	...
	SetLabel(  appBundle.GetString(theInfo.keyLabel));
	SetHelpTag(appBundle.GetString(theInfo.keyHelpTagStd), false);
	SetHelpTag(appBundle.GetString(theInfo.keyHelpTagExt), true);
