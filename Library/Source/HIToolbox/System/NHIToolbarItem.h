...
//
//
// Item images are identified with a string, which is typically a resource in
// the application bundle.
//
// If no such resource exists then four-character resImage values are treated
// as kSystemIconsCreator icons, with other values assumed to be the bundle
// identifier of an application whose icon should be used for the item.
//
// For example:
//
//		resImage = "Preferences.png";				// Contents/Resources/Preferences.png
//		resImage = "tdel";							// kToolbarDeleteIcon
//		resImage = "com.apple.AddressBook";			// AddressBook.app icon
//
// If no resource can be identified for the item, the image will be blank.
typedef struct {
	NString				theIdentifier;				// Item identifier
	UInt32				theCommand;					// Item command
    NString             resImage;                   // Item image resource
...
// Items
static const HIToolbarItemInfo kToolbarItemSeparator					= { kHIToolbarSeparatorIdentifier		};
static const HIToolbarItemInfo kToolbarItemSpace						= { kHIToolbarSpaceIdentifier			};
static const HIToolbarItemInfo kToolbarItemFlexibleSpace				= { kHIToolbarFlexibleSpaceIdentifier	};
static const HIToolbarItemInfo kToolbarItemCustomize					= { kHIToolbarCustomizeIdentifier		};
static const HIToolbarItemInfo kToolbarItemPrint						= { kHIToolbarPrintItemIdentifier		};
static const HIToolbarItemInfo kToolbarItemFonts						= { kHIToolbarFontsItemIdentifier		};
static const HIToolbarItemInfo kToolbarItemUnifiedInset					= { kHIToolbarUnifiedInsetIdentifier	};
