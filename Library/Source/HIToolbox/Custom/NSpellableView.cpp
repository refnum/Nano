...
//============================================================================
//		NSpellableView::IsSpellingAsYouTypeEnabled : Get the as-you-type state.
//----------------------------------------------------------------------------
bool NSpellableView::IsSpellingAsYouTypeEnabled(void) const
{

	// Get the state
	return(mCheckAsYouType);
}
...
//============================================================================
//		NSpellableView::SetSpellingAsYouTypeEnabled : Set the as-you-type state.
//----------------------------------------------------------------------------
void NSpellableView::SetSpellingAsYouTypeEnabled(bool theFlag)
{

	// Set the state
	if (mCheckAsYouType != theFlag)
		CommandCheckSpellingAsYouType();
}
