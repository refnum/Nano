...
//
// Regisers an HIView sub-class under an alternative name. This can be used
// when a system view has been registered under different names on different
// OS releases.
//
// Example usage:
//
...
protected:
	...
	// be used to customise the appearance or behaviour of the view.
