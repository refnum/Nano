...
//============================================================================
//		NHIView::GetPercentageValue : Get the percentage value.
//----------------------------------------------------------------------------
float NHIView::GetPercentageValue(void) const
...
//============================================================================
//		NHIView::SetPercentageValue : Set the percentage value.
//----------------------------------------------------------------------------
void NHIView::SetPercentageValue(float theValue)
{	float	theRange;
