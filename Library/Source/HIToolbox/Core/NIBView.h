...
//
// Views can be declared with a signature and default ID of 0 (NIB_VIEW), or with
// a signature and explicit ID (NIB_VIEW_ID).
#define NIB_VIEW_ID(_signature, _id, _class, _name)									\
																					\
...
#define NIB_VIEW(   _signature,    _class, _name)									\
		NIB_VIEW_ID(_signature, 0, _class, _name)
