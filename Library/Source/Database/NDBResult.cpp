...
//----------------------------------------------------------------------------
UInt32 NDBResult::GetSize(void) const
{
...
//----------------------------------------------------------------------------
NString NDBResult::GetName(UInt32 theIndex) const
{
...
//----------------------------------------------------------------------------
SInt32 NDBResult::GetValueSInt32(UInt32 theIndex) const
{
...
//----------------------------------------------------------------------------
SInt64 NDBResult::GetValueSInt64(UInt32 theIndex) const
{
...
//----------------------------------------------------------------------------
Float32 NDBResult::GetValueFloat32(UInt32 theIndex) const
{
...
//----------------------------------------------------------------------------
Float64 NDBResult::GetValueFloat64(UInt32 theIndex) const
{
...
//----------------------------------------------------------------------------
NString NDBResult::GetValueString(UInt32 theIndex) const
{	NString					theResult;
	...
	if (thePtr != NULL && theSize != 0)
		theResult = NString((const char *) thePtr, theSize, kCFStringEncodingUTF8);
...
//----------------------------------------------------------------------------
NData NDBResult::GetValueData(UInt32 theIndex) const
{	NData			theResult;
	const void		*thePtr;
	UInt32			theSize;
...
//----------------------------------------------------------------------------
void NDBResult::GetRowValueSInt32(const NDBResult &theRow, UInt32 theIndex, SInt32 *theValue)
{
...
//----------------------------------------------------------------------------
void NDBResult::GetRowValueSInt64(const NDBResult &theRow, UInt32 theIndex, SInt64 *theValue)
{
...
//----------------------------------------------------------------------------
void NDBResult::GetRowValueFloat32(const NDBResult &theRow, UInt32 theIndex, Float32 *theValue)
{
...
//----------------------------------------------------------------------------
void NDBResult::GetRowValueFloat64(const NDBResult &theRow, UInt32 theIndex, Float64 *theValue)
{
...
//----------------------------------------------------------------------------
void NDBResult::GetRowValueString(const NDBResult &theRow, UInt32 theIndex, NString *theValue)
{
...
//----------------------------------------------------------------------------
void NDBResult::GetRowValueData(const NDBResult &theRow, UInt32 theIndex, NData *theValue)
{
...
//----------------------------------------------------------------------------
void NDBResult::GetRowValuesSInt32(const NDBResult &theRow, UInt32 theIndex, SInt32List *theValues)
{
...
//----------------------------------------------------------------------------
void NDBResult::GetRowValuesSInt64(const NDBResult &theRow, UInt32 theIndex, SInt64List *theValues)
{
...
//----------------------------------------------------------------------------
void NDBResult::GetRowValuesFloat32(const NDBResult &theRow, UInt32 theIndex, Float32List *theValues)
{
...
//----------------------------------------------------------------------------
void NDBResult::GetRowValuesFloat64(const NDBResult &theRow, UInt32 theIndex, Float64List *theValues)
{
...
//----------------------------------------------------------------------------
void NDBResult::GetRowValuesString(const NDBResult &theRow, UInt32 theIndex, NStringList *theValues)
{
...
//----------------------------------------------------------------------------
void NDBResult::GetRowValuesData(const NDBResult &theRow, UInt32 theIndex, NDataList *theValues)
{
