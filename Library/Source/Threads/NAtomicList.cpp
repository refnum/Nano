...
void SuppressNoCodeLinkerWarning(void);
void SuppressNoCodeLinkerWarning(void)
{
}
...
//----------------------------------------------------------------------------
template<class T> UInt32 NAtomicList<T>::GetSize(void) const
...
//----------------------------------------------------------------------------
template<class T> bool NAtomicList<T>::Lock(EventTime theTime)
{
...
//----------------------------------------------------------------------------
template<class T> T NAtomicList<T>::GetValue(UInt32 theIndex) const
{	StLock					theLock(mMutex);
