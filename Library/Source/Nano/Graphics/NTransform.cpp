...
{	NArray		theArray;
	...
	if (is64)
		theArray = NArray(nvector(mA.GetFloat64(), mB.GetFloat64(), mC.GetFloat64(), mD.GetFloat64(), mTX.GetFloat64(), mTY.GetFloat64()));
	else
		theArray = NArray(nvector(mA.GetFloat32(), mB.GetFloat32(), mC.GetFloat32(), mD.GetFloat32(), mTX.GetFloat32(), mTY.GetFloat32()));
