...
//============================================================================
//		NGeometryUtilities::GetCentre : Get the center point.
//----------------------------------------------------------------------------
HIPoint NGeometryUtilities::GetCentre(const HIRect &theRect)
{	HIPoint		thePoint;
...
//		NGeometryUtilities::GetCentre : Get the center point.
//----------------------------------------------------------------------------
HIPoint NGeometryUtilities::GetCentre(const HISize &theSize)
{


	// Get the centre point
	return(GetCentre(CGRectMake(0.0f, 0.0f, theSize.width, theSize.height)));
}
