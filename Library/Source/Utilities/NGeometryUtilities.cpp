...
CGRect32 NGeometryUtilities::GetBounds(const CGPoint32List &thePoints)
{
	...
	return(GetBounds<CGPoint32List, CGRect32>(thePoints));
}
...
CGRect64 NGeometryUtilities::GetBounds(const CGPoint64List &thePoints)
{
	...
	// Get the bounding box
	return(GetBounds<CGPoint64List, CGRect64>(thePoints));
}
...
//----------------------------------------------------------------------------
#pragma mark -
template <class P, class R> R NGeometryUtilities::GetBounds(const P &thePoints)
{	Float64		minX, minY, maxX, maxY;
	...
	theRect.origin.x    = minX;
	theRect.origin.y    = minY;
	theRect.size.width  = maxX - minX;
	theRect.size.height = maxY - minY;
