...
static const EndianFormat kEndianNative							= (TARGET_RT_BIG_ENDIAN ? kEndianBig : kEndianLittle);
...
static const UInt32 kInvalidIndex								= (UInt32) -1;
...
public:
	...
	// Dispatch events on the current event loop
	static void							DispatchCurrentEventLoop(EventTime theTime=kThreadSleep);
	...
	// Invoke a functor after a delay
