...
//----------------------------------------------------------------------------
void NTextUtilities::GetStr255(const NString &theString, Str255 &theValue)
{


	// Convert the string
	if (!CFStringGetPascalString(theString, theValue, 256, kCFStringEncodingMacRoman))
		theValue[0] = 0x00;
}
...
{	NString		theString;
	...
	// Convert the value
	theString = NString((char *) &theValue, 4);
...
//----------------------------------------------------------------------------
NString NTextUtilities::FromStr255(ConstStr255Param theValue)
{	NString		theString;



	// Convert the value
	theString = NString((const char *) &theValue[1], theValue[0], kCFStringEncodingMacRoman);
