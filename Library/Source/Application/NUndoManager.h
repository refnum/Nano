...
public:
	...
	// Get an undo/redo string
	//
	// Given an undo/redo command, the command status, and an optional action,
	// this returns an appropriately localised string to represent the command.
	static NString						GetCommandString(UInt32 cmdID, CommandStatus cmdStatus, const NString &cmdName="");
