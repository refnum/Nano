...
//		Class declaration
//----------------------------------------------------------------------------
class NDocument : public NWindowController, public NPropertyStore {
public:
										NDocument(void);
...
protected:
	...
	//
	// Sub-classes should call through to allow the base class to archive properties.
	...
	//
	// Sub-classes should override to customise the window appearance.
	...
	//
	// Sub-classes should override to customise the print job.
