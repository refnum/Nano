...
// Timers
static const NTimerID kTimerCheckForUpdates								= 1000;
...
OSStatus NApplication::InitializeEnd(void)
{
	...
	// Check for updates
	AddTimer(0.0, kSoftwareUpdateCheckTime, kTimerCheckForUpdates);
...
//============================================================================
//		NApplication::DoTimer : Handle a timer.
//----------------------------------------------------------------------------
void NApplication::DoTimer(NTimerID theTimer, TimerMsg theMsg)
{


	// Handle the timer
	switch (theTimer) {
		case kTimerCheckForUpdates:
			CheckForUpdates();
			break;
