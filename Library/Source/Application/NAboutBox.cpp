...
//============================================================================
//		NAboutBox::DoEventCommandProcess : Hande kEventCommandProcess.
//----------------------------------------------------------------------------
...
{	NString			theTitle, theDescription, buttonOne, buttonTwo, buttonThree, theValue;
	...
	// Reset the bounds
	theWindow->SetBounds(		NGeometryUtilities::Transform(kBoundsWindow));
	...
	theRect.origin.x = (theWindow->GetBounds().size.width / 2.0f) - (theRect.size.width / 2.0f);
