...
{	NRangeList		rangesUTF8, rangesUTF16, rangesUTF32;
	...
	REQUIRE(rangesUTF8  == mkvector(NRange(0,3), NRange(3,3), NRange(6,3)));
	REQUIRE(rangesUTF16 == mkvector(NRange(0,2), NRange(2,2), NRange(4,2)));
	REQUIRE(rangesUTF32 == mkvector(NRange(0,4), NRange(4,4), NRange(8,4)));
